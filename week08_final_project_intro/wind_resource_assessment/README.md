...
Horns Rev 1 site (55°31′47″N, 7°54′22″E), using interpolation.
...
### Other tips
* You are strongly suggested to go through the provided note: 
[**Interpolation in Python: An Introduction with `NumPy` and  `SciPy`**](../../notes_and_tips/1_note_on_interpolation.md)
* When you are done with the listed functional requirements, consider extend 
your package with more functionalites, for example:
    - You may implement also the logarithemic law profile, and compare the
    AEP differences of a given turbine, induced by the different vertical 
    extrapolation methods.
    - You may implement a function to return the joint propability of a user
    inputted wind speed and wind direction at a given location (inside the box) 
    and a given height.
    - You may extend your package to predict the AEP of a wind farm.
    - You may extend your package to generate animated flow map inside the area
...
better characterize the wind condition, you may check the model proposed in 
(Feng and Shen, 2015).
